...
class CNNModel:
    def __init__(self, input_shape, num_classes=1, learning_rate=0.0005):
    ...
    def _build_model(self, model_type):
        model = tf.keras.Sequential([
            tf.keras.layers.Conv2D(32, (3, 3), activation='relu', input_shape=self.input_shape, kernel_regularizer=l2(0.001)),
